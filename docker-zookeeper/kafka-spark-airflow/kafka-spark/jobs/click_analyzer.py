...
from pyspark.sql.functions import window, col, count, desc, from_json, approx_count_distinct, countDistinct, to_timestamp, udf, approx_count_distinct
...
def main():
    ...
    try:
        ...
        suspicious_activity_df = clicks_with_timestamp_df \
            ...
            .agg(approx_count_distinct("page_url").alias("distinct_page_count")) \
